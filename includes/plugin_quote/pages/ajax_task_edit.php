...
<tr class="task_editting task_row_<?php echo $quote_task_id;?>" >
    <td>
       ...
       <br>
       Width: <input type="text" name="quote_task[<?php echo $quote_task_id;?>][width]" value="<?php echo $task_data['width'];?>" size="3" style="width:30px;" tabindex="12">
       Height: <input type="text" name="quote_task[<?php echo $quote_task_id;?>][height]" value="<?php echo $task_data['height'];?>" size="3" style="width:30px;" tabindex="12">
       Lite: <input type="text" name="quote_task[<?php echo $quote_task_id;?>][lite]" value="<?php echo $task_data['lite'];?>" size="3" style="width:30px;" tabindex="12">
        <?php
