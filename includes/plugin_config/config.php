...
/*
    ...
    public function get_install_sql(){
        ...
        INSERT INTO `<?php echo _DB_PREFIX;?>config` SET `key` = '_installation_code', `val` = '1100806b-c9fc-484c-80fa-ee3b4b7a2080';
        <?php /* default email settings from the installer: */ 
 self::$_c['admin_email_address'] = 'info@itecht.com' 
 ?> 
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'admin_email_address', `val` = 'info@itecht.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'customer_signup_admin_email', `val` = 'info@itecht.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'error_email_address', `val` = 'info@itecht.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'newsletter_default_from_email', `val` = 'info@itecht.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'newsletter_default_bounce', `val` = 'info@itecht.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'ticket_admin_email_alert', `val` = 'info@itecht.com';
